...
export class APIRootBuilder {
  ...
  public withAnonymousSessionFlow() {
    return this.createRequestAPI(this.client.withAnonymousSessionFlow(requestAPIConfig.anonymousMiddlewareOptions));

  }

  public withPasswordFlow(password: string, login: string) {
    requestAPIConfig.passwordAuthMiddlewareOptions.credentials.user.password = password;
    requestAPIConfig.passwordAuthMiddlewareOptions.credentials.user.username = login;
    return this.createRequestAPI(this.client.withPasswordFlow(requestAPIConfig.passwordAuthMiddlewareOptions));
  }
  ...
  public withRefreshTokenFlow() {
    ...
    return this.createRequestAPI(this.client.withRefreshTokenFlow(requestAPIConfig.refreshMiddlewareOptions))
  }
