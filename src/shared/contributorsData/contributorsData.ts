...
import rssHero from "../../assets/images/rss-image.svg";
import rss from "../../assets/images/rss.svg";

import dimaGitImg from "../../assets/images/dima.svg";
import tanyaGitImg from "../../assets/images/tanya.svg";
import alexGitImg from "../../assets/images/alex.svg";
...
export const contributorsData = {
  ...
  teacherLogo: rss,
  teacherHeroIcon: rssHero,
  teacherCourseLink: "https://rs.school/courses",
};
